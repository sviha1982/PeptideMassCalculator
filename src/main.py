...
if c_option == "other":
    c_input = st.text_input("Type name, monoisotopic and average mass (e.g. egal, 101.0603, 101.1250)")
...
if n_mono is None or c_mono is None:
    ...
    st.write("monoisotopic mass:", calculate_total_ms(sum_mono, n_mono, c_mono, "mono"))
    st.write("average mass:", calculate_total_ms(sum_avg, n_avg, c_avg, "avg"))
